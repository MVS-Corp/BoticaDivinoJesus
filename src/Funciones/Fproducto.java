...
public class Fproducto {
    ...
    public DefaultTableModel mostrar(String buscar) {
        ...
        String[] titulos
                = {"Codigo de Barra", "Nombre del Producto",
                    "Forma Farmaceutica", "Unidad  ",
                    "Precio Unitario", "Stock",
                    "Precio por Empaque", "Ubicacion",
                    "Categoria"};
    ...
    public boolean insertar(Dproducto datos,String nombre) {
        ...
        try {
            ...
            pst.setDouble(5, datos.getPrecio_producto());
    ...
    public boolean editar(Dproducto datos, String nombre) {
        ...
        try {
            ...
            pst.setDouble(4, datos.getPrecio_producto());
            pst.setLong(5, datos.getStock_producto());
            pst.setDouble(6, datos.getPrecio_compra());
    ...
    public DefaultTableModel mostrarExportar(String buscar) {
        ...
        String[] titulos
                = {"Codigo de Barra", "Nombre del Producto  ",
                    "Forma Farmaceutica", "Unidad  ",
                    "Precio Unitario", "Stock", "Precio por Empaque", "Ubicacion"};
